  ...
  return (
    <div className={`card${wide ? " span2" : ""}`} onClick={()=>onSelect(p)} style={{position:"relative"}}>
      ...
      <div className="card-img-wrap">
        ...
        {p.destacado && <div style={{position:"absolute",top:10,left:10,background:"#B8860B",color:"white",fontSize:9,letterSpacing:".1em",textTransform:"uppercase",padding:"4px 8px",fontFamily:"DM Sans,sans-serif",fontWeight:600}}>★ Destacada</div>}
      </div>
          ...
          <div>
            ...
            <div style={{position:"relative",width:"100%",height:160,overflow:"hidden",border:"1px solid rgba(255,255,255,.08)",marginBottom:10}}>
              <iframe
                ...
                loading="lazy"
                src="https://www.google.com/maps/embed?pb=!4v1700000000000!6m8!1m7!1sCAoSLEFGMVFpcE94WkpNNzFSZlhQV3lZeGhPV0tKbEVYcWlVMUxlQ0F5YU5YZUVM!2m2!1d-37.9718679!2d-57.5474389!3f180!4f0!5f0.7820865974627469"
              />
            </div>
